    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((command = Console.ReadLine()) != "end of assignment")
            {
                ...
                if (teams.Any(team => team.Creator == userName) ||
                    teams.Any(team => team.Members.Contains(userName)))
                {
                    Console.WriteLine($"Member {userName} cannot join team {teamName}!");
                    continue;
                }

                teams.Find(team => team.Name == teamName).Members.Add(userName);
            }
            ...
            List<Team> orderedTeams = teamsLeft
